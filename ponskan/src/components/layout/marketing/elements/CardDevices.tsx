    ...
    return(
        ...
        <div className="flex flex-col gap-4">  
            ...
            <div className="flex rounded-2xl overflow-hidden">
                <label className={`flex flex-1 flex-col px-4 py-2 cursor-pointer transition-colors ${selected === 'web' ? 'bg-slate-50/40' : 'hover:bg-slate-50/33'}`}>
                    <input type="radio" className="hidden" onChange={() => setSelected('web')} checked={selected === 'web'}/>
                    <h3 className="font-semibold text-xl text-slate-50">Web</h3>
                    <p className="text-base text-slate-50">Gerenciamento total do pomar.</p>
                </label>

                <label className={`flex flex-1 flex-col px-4 py-2 cursor-pointer transition-colors ${selected === 'mobile' ? 'bg-slate-50/40' : 'hover:bg-slate-50/33'}`}>
                    <input type="radio" className="hidden" onChange={()=> setSelected('mobile')} checked={selected === 'mobile'}/>
                    <h3 className="font-semibold text-xl text-slate-50">Dispositivos móveis</h3>
                    <p className="text-base text-slate-50">Principais funcionalidades via app.</p>
                </label>
            </div>

            <div className="flex flex-col flex-1 h-[80%] bg-slate-50 rounded-2xl shadow-2xl">
