...
export const Header = () => {
    return (
        <>
        <nav className='flex items-center w-full max-w-400 mx-auto pt-10 px-4 select-none font-inter z-100'>
            <Link href="/">
            ...
            <ul className="flex gap-2 w-fit ml-auto md:gap-6">
                ...
                <li> 
                    <Link href="" className="flex relative items-center px-4 h-10 rounded-full text-white text-base font-medium overflow-hidden whitespace-nowrap group">
                        <span className="hidden md:block z-1">Criar uma conta</span> <span className="block md:hidden z-1">Criar</span>
