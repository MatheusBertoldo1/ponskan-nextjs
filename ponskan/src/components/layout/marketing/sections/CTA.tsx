...
export const CTA = () => {
    return (
        ...
        <section className="flex flex-col w-full h-125 items-center justify-center gap-8 px-5 bg-amber-500 select-none font-inter">
            ...
            <Link href="" className="px-4 py-2 rounded-full bg-slate-50 text-base font-medium text-amber-600 hover:bg-slate-100/93 transition-colors ">Quero minha safra produzindo</Link>
        </section>
        </>
    )
}