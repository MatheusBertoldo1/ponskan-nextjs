...
export const CTA = () => {
    return (
        <>
        <section className="flex flex-col w-full h-125 items-center justify-center gap-8 px-5 bg-amber-500">
            <h3 className="max-w-175 text-center text-4xl font-semibold text-amber-900">Não deixe sua safra se desvalorizar</h3>
