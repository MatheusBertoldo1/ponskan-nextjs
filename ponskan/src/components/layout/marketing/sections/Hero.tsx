        ...
        <section id="hero" className="flex flex-col relative min-h-dvh px-4 select-none">
            ...
            <div className="flex flex-1 flex-col justify-center items-center pt-12 gap-6">
                ...
                <div className="flex gap-4 flex-wrap justify-center z-1">
                    <Link href="/signup" className="font-lexend flex items-center whitespace-nowrap px-4 h-12 bg-amber-500 text-white text-base font-medium border rounded-full hover:bg-amber-600/90 transition-colors duration-200 ease-in-out">Quero meu pomar saudável</Link>
