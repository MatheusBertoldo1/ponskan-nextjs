...
import { PlayIcon, ChevronDownIcon } from "@/assets/icons/HeroIcons"
...
export const Hero = () => {
    return(
        <>
        <section id="hero" className="flex flex-col relative h-dvh px-4 select-none">
            <Header />
            ...
            <div className="flex flex-1 flex-col justify-center items-center gap-6">
                ...
                <p className="mt-40 text-slate-700 text-center font-medium font-lexend z-1">As melhores tecnologias do mercado trabalhando junto com você</p>
                
                <Link href="#devices" className="flex mt-10">
                    <ChevronDownIcon className="w-15 h-15  text-slate-300 z-1"/>
                </Link>
            </div>
