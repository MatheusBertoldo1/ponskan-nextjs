...
export const Hero = () => {
    return(
        ...
        <section id="hero" className="flex flex-col h-172 items-center justify-center gap-6 select-none">
            ...
            <h2 className="max-w-175 text-center text-2xl text-slate-500 font-semibold">Proteja sua safra, reduza em até 30% o uso de defensivos ao identificar o momento biológico exato para a aplicação.<span className="text-amber-500"> Menos desperdício, mais margem.</span></h2>
