                    ...
                    <div className="flex flex-1 flex-col">
                        ...
                        <div className="flex gap-3 pl-4 py-4">
                            <div className="flex flex-col w-fit px-2 py-2 rounded-xl border border-slate-300">
                                <h3 className="text-lg font-medium">Índice alfa</h3>
                                <p className="text-4xl font-bold">100 <span className="inline-flex px-2 font-normal text-sm text-green-600 rounded-sm bg-green-200 ">+7,5%</span></p>
                        ...
                        <div className="flex flex-col gap-3 pl-4 py-4 ml-4 rounded-xl border border-slate-300">
                            <h3 className="text-lg font-bold">Análise e confirmação</h3>
                            ...
                            <div className="flex gap-3 w-fit px-4">
                                ...
                                <div className="w-130 h-full overflow-x-scroll">
                                    <div className="flex h-full w-max gap-2">
                                        ...
                                        <div className="flex flex-col-reverse items-center w-21">
                                            <p className="text-sm">12 abril, 2026</p>
                                            <p>Domingo</p>
                                            <div className="flex flex-col-reverse h-[20%] w-[70%] bg-slate-200 rounded-sm">
                                                <div className="flex w-full h-2 rounded-sm bg-amber-500"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
